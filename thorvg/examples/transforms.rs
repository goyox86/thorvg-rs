...
fn main() {
    ...
    s1.append_rect(Rect { x: 0.0, y: 0.0, width: 60.0, height: 60.0, rx: 5.0, ry: 5.0, cw: true })
        .unwrap();
    ...
    s2.append_rect(Rect { x: 0.0, y: 0.0, width: 60.0, height: 60.0, rx: 5.0, ry: 5.0, cw: true })
        .unwrap();
    ...
    s3.append_rect(Rect { x: 0.0, y: 0.0, width: 60.0, height: 60.0, rx: 5.0, ry: 5.0, cw: true })
        .unwrap();
    ...
    s4.append_rect(Rect { x: 0.0, y: 0.0, width: 60.0, height: 60.0, rx: 5.0, ry: 5.0, cw: true })
        .unwrap();
    ...
    s5.append_rect(Rect { x: 0.0, y: 0.0, width: 60.0, height: 60.0, rx: 5.0, ry: 5.0, cw: true })
        .unwrap();
    ...
    for i in 0..8 {
        ...
        s.append_rect(Rect { x: 0.0, y: 0.0, width: 30.0, height: 30.0, rx: 3.0, ry: 3.0, cw: true }).unwrap();
        let hue = (i * 32) as u8;
