...
fn main() {
    ...
    for row in 0..(h / 15) {
        for col in 0..(w / 15) {
            ...
            sq.append_rect(col as f32 * 15.0, row as f32 * 15.0, 15.0, 15.0, 0.0, 0.0, true).unwrap();
    ...
    rect1.append_rect(30.0, 50.0, 200.0, 200.0, 0.0, 0.0, true).unwrap();
    ...
    rect2.append_rect(260.0, 50.0, 200.0, 200.0, 0.0, 0.0, true).unwrap();
